...
const newEntityOptions = computed(() => [
  ...
  {
    group: window.__("Upload"),
    items: [
      {
        label: window.__("Upload File"),
        icon: LucideFileUp,
        onClick: () => emitter.emit("uploadFile"),
      },
      {
        label: window.__("Upload Folder"),
        icon: LucideFolderUp,
