<template>
  ...
  >
    ...
    >
      ...
      {{ __("Please ask your site's administrator to set the access key in the") }}
      <a
    ...
    <template v-else>
      ...
      <span class="text-p-base text-center text-ink-gray-7">
        {{ __("This preview is generated by an external service (Microsoft), not by Drive. For extra privacy, we'd suggest downloading.") }}
      </span>
...
watch(warned, async () => {
  ...
  if (message) {
    ...
    error.value = __("Please set up your Drive Settings.")
  }
})
